...
import { Building2, LayoutDashboard, LogOut, Users, Network, Coins, Wallet, ShieldCheck, FileText, Menu } from 'lucide-react';
...
type Page = 'dashboard' | 'companies' | 'employees' | 'organisation' | 'salary';
